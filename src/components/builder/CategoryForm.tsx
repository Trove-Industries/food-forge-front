...
const CategoryForm = ({ categories, onSave }: CategoryFormProps) => {
  ...
  const addCategory = () => {
    ...
    // API Integration Point: POST /api/categories
  };
  ...
  const removeCategory = (id: string) => {
    ...
    // API Integration Point: DELETE /api/categories/:id
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Add categories to organize your menu items</p>
      </div>
